...
def chat_completion(PROMPT, MaxToken=50, outputs=3):
...
def main():
    ...
    input_file = 'files/' + sys.argv[1]
    output_file = 'files/' + sys.argv[2]  
    max_token = sys.argv[3]
    outputs = sys.argv[4]   
    dynamic_chat_completion_with_files(input_file, output_file, max_token, outputs)
